...
void InitStructs()
{
    ...
    Guy.ResourceAmount[Water] = 100;
    Guy.ResourceAmount[Food] = 100;
    Guy.ResourceAmount[Health] = 100;
...
void NewGame(bool neu)
{
    ...
    if ((!LoadOK) || (neu))
    {
        ...
        Guy.ScreenPosition.x = (Landscape[Guy.Pos.x][Guy.Pos.y].xScreen + CornerCoord[Landscape[Guy.Pos.x][Guy.Pos.y].Type][0].x + Landscape[Guy.Pos.x][Guy.Pos.y].xScreen +
            CornerCoord[Landscape[Guy.Pos.x][Guy.Pos.y].Type][2].x) / 2;
        Guy.ScreenPosition.y = (Landscape[Guy.Pos.x][Guy.Pos.y].yScreen + CornerCoord[Landscape[Guy.Pos.x][Guy.Pos.y].Type][1].y + Landscape[Guy.Pos.x][Guy.Pos.y].yScreen +
            CornerCoord[Landscape[Guy.Pos.x][Guy.Pos.y].Type][3].y) / 2;
