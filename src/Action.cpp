...
namespace Action
{
    ...
    void log()
    {
        ...
        case 9:
            ...
            if (Guy.Inventory[RAW_TREE_BRANCH] > 10) Guy.Inventory[RAW_TREE_BRANCH] = 10;
            Guy.Inventory[RAW_LEAF] += 5;
            if (Guy.Inventory[RAW_LEAF] > 10) Guy.Inventory[RAW_LEAF] = 10;
            Guy.Inventory[RAW_LIANA] += 2;
            if (Guy.Inventory[RAW_LIANA] > 10) Guy.Inventory[RAW_LIANA] = 10;
            Guy.CurrentAction = NOTHING;
            break;
        }
    }
    ...
    void day_end()
    {
        ...
        case 12:
            ...
            Guy.AnimationState = GUY_LEFT;
            Guy.CurrentAction = NOTHING;
            if (Guy.ResourceAmount[GESUNDHEIT] > 10) Game::SaveGame();
            break;
        }
    }
