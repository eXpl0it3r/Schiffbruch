...
struct GUY
{
    ...
    short Inventar[ImageCount]; // Welche Rohstoffe usw. besitzt man
};
...
struct BMP
{
    ...
    // zum bauen
    short Rohstoff[ImageCount]; // Anzahl des i.Rohstoffs, den man zum Bau benötigt
...
struct SCAPE
{
    ...
    short Rohstoff[ImageCount]; // Anzahl des i.Rohstoffs, den man noch zum bauen braucht
